...
│
├── data
│   └── raw/seoul_factory_registry_2025_v1.csv          # 서울시 공장등록 원본
...
└── code
    ...
    │   ├── aird_ml_learning_examples.ipynb             # 고급 ML 예제
...
* `data/raw/seoul_factory_registry_2025_v1.csv`는 '(2025.10월말기준)_공장등록통계.xlsx' 파일을 전처리하고, 서울특별시 데이터만 뽑아서 가공한 데이터입니다. 

### ML-Pack

#### ✅ 테스트 파일
아래 파일들을 순서대로 테스트 합니다. 
